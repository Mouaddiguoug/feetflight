...
class UsersController {
  ...
  public generateAiPictures = async (
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> => {
  ...
  public checkForSale = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const checkForSubscription = await this.userService.checkForSubscriptionbyUserId(
        userId,
        postId,
        plan
      );
  ...
  public unlockSentPicture = async (
    ...
    try {
      ...
      const unlockSentPictureSession = await this.userService.unlockSentPicture(
        userId,
        unlockSentPictureData
      );
  ...
  public signOut = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      res
        ...
        .json({ message: result ? 'You have loged out successfully' : 'Something went wrong' });
    } catch (error) {
      next(error);
    }
  };
  ...
  public checkForSubscribtion = async (
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> => {
  ...
  public uploadDeviceToken = async (
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> => {
