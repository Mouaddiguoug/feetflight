// @deprecated This test file is for deprecated Express routes and may not work with the current Elysia architecture.
import request from 'supertest';
import App from '@/app';
// import { CreateUserDto } from '@dtos/users.dto'; // CreateUserDto is not defined anywhere
