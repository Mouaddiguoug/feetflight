        ...
        <Container style={containerStyle}>
          <Section style={sectionStyle}>
            ...
            <Text style={textStyle}>
              We have received a request to change the password associated with
              your account. As part of our security measures, we have generated
              an OTP to verify your identity for this action.
            </Text>
