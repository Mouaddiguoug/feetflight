...
export function adminRoutes() {
  return new Elysia({ name: 'routes.admin' })
    .group('/admin', (app) =>
      app
        .use(authGuard())
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Retrieves seller identity card images (front and back) for verification purposes',
            },
          }
        )
        ...
        .get(
          ...
          },
          {
            detail: {
              ...
              description: '⚠️ REQUIRES STAKEHOLDER CONFIRMATION - This route was not exposed in the original API. Retrieves all sellers pending verification. Needs admin-role guard implementation before production use.',
            },
          }
        )
    );
