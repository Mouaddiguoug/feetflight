      ...
      app
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Retrieves all notifications for a user with relative time formatting (e.g., "5 minutes ago")',
            },
          }
        )
        ...
        .post(
          ...
          async ({ params, body, neo4j, log, set }) => {
            ...
            await pushMessageNotification(params.id, 'Message', message, body.avatar || '', { neo4j, log });
            set.status = 201;
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Sends a push notification to user via Firebase Cloud Messaging with optional avatar image',
            },
          }
        )
    );
