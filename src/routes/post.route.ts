...
class postRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/categories`, authMiddleware, this.postController.getCategories);
    this.router.post(`${this.path}/:id`, authMiddleware, this.postController.createPost);
    this.router.post(`${this.path}/upload/:id`, authMiddleware, multer().array("postPicture"), fileMiddleware, this.postController.uploadPostPictures);
