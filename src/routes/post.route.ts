...
import { CreatePostSchema, LikePostSchema, GetRandomAlbumsParamSchema } from '@/schemas/posts.schema';
import { PostPicturesUploadSchema } from '@/schemas/files.schema';
...
export function postRoutes() {
  return new Elysia({ name: 'routes.post' })
    .group('/albums', (app) =>
      app
        .use(loggerPlugin())
        .use(neo4jPlugin())
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Retrieves random albums from subscribed sellers with pagination support. Returns albums sorted by likes.',
            },
          },
        )
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Retrieves all albums created by a specific seller, sorted by views in descending order.',
            },
          },
        )
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Retrieves the subscription plan details associated with a specific album/post.',
            },
          },
        )
        ...
        .post(
          ...
          },
          {
            ...
            detail: {
              tags: ['Albums'],
              summary: 'Like Post',
              description: 'Creates a like relationship between user and post, increments like count, and sends push notification to seller.',
            },
          },
        )
        ...
        .post(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Uploads multiple picture files (1-20 images, max 5MB each) for a post collection. Public endpoint with NO authentication (security issue from original implementation). Consider adding authGuard + sellerGuard for production use.',
            },
          },
        )
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Retrieves popular albums sorted by views in descending order (up to 20 albums). Requires authentication.',
            },
          },
        )
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Retrieves all albums belonging to a specific category, sorted by creation date. Requires authentication.',
            },
          },
        )
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Retrieves all picture nodes associated with a specific post/album. Requires authentication.',
            },
          },
        )
        ...
        .get(
          ...
          },
          {
            detail: {
              ...
              description: 'Retrieves all available album categories from the database. Requires authentication.',
            },
          },
        )
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Retrieves all albums excluding those from the specified user, sorted by views. Requires authentication. (Fixed param name bug: now uses :id instead of :userId)',
            },
          },
        )
        ...
        .delete(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Deletes an album/post along with its collection and all associated pictures using DETACH DELETE. Requires authentication.',
            },
          },
        )
        ...
        .put(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Increments the view count for a specific post/album by 1. Requires authentication.',
            },
          },
        )
        ...
        .post(
          ...
          },
          {
            ...
            detail: {
              tags: ['Albums'],
              summary: 'Create Post',
              description: 'Creates a new post/album with associated collection and Stripe product. Links post to seller, plan, and category. Requires authentication and verified seller status.',
            },
          },
        ),
    );
