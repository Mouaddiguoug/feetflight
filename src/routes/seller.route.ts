...
import { IdentityCardUploadSchema, SentPictureUploadSchema } from '@/schemas/files.schema';
        ...
        .post(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Create multiple subscription plans for a seller with Stripe integration',
            },
          },
        )
