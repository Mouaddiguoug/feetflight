...
import { ChangePasswordSchema, EmailParamSchema } from '@/schemas/auth.schema';
import { CheckForSaleParamSchema } from '@/schemas/posts.schema';
import { AvatarUploadSchema } from '@/schemas/files.schema';
...
export function usersRoutes() {
  return new Elysia({ name: 'routes.users' })
    .group('/users', app =>
      app
        .use(neo4jPlugin())
        .use(loggerPlugin())
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Confirms user email using verification token and redirects to success page',
            },
          },
        )
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Generates AI pictures of feet using OpenAI based on color and category parameters',
            },
          },
        )
        ...
        .post(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Generates and sends a 4-digit OTP to user email for password reset (valid for 2 minutes). Returns raw hash string for backward compatibility.',
            },
          },
        )
        ...
        .get(
          ...
          async ({ params, UserServiceDeps }) => {
            ...
            const checkForSubscription = await checkForSubscriptionbyUserId(params.userId, params.postId, params.plan, UserServiceDeps);
        ...
        .post(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Creates Stripe checkout session to unlock a sent picture. Returns { url } containing the checkout URL for consistency with buyPosts endpoint.',
            },
          },
        )
        ...
        .get(
          ...
          },
          {
            ...
            detail: {
              ...
              description: '[DEPRECATED] Use POST variant instead. Checks if user is subscribed to seller. Migrate to POST /verify/checkForSubscription/:id with body for cleaner semantics.',
            },
          },
        )
